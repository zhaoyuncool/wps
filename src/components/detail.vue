<template>
	<div class="detail">
		...
		<div class="content">
		  <div class="header clear"><h2><img :src="detail.author_face?detail.author_face:'../assets/img/head.png'" alt=""/></h2><p>作者名字</p></div>
		  <div class="cont">
		    <h3>{{detail.title}}</h3>
		    <div class="time"><p>{{detail.time | date}}/{{1| fillzero}}<span><img :src="detail.author_face?detail.author_face:'../assets/img/head.png'" alt=""/></span></p></div>
