	...
	<div class="foot-btn" >
	  <ul>
	    ...
	    <!-- <li class="my"><a href="javascript:;"></a></li> -->
			<router-link active-class="active" class="home" to="/home" tag="li"><a href="javascript:;"></a></router-link>
			<router-link active-class="active" class="write" to="/write" tag="li"><a href="javascript:;"></a></router-link>
			<router-link active-class="active" class="my" to="/user" tag="li"><a href="javascript:;"></a></router-link>
	  </ul>
	</div>
</template>
